...
```javascript
import iterMapN from 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-mapn@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/iter-mapn/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/iter-mapn/actions/workflows/test.yml?query=branch:v0.2.3
